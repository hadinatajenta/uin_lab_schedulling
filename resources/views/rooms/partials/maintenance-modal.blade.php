                    ...
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                            ...
                            <div class="mt-4 space-y-4">
                                <div>
                                    <label class="block text-sm font-medium text-foreground-muted">Type</label>
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-foreground-muted">Title</label>
                                ...
                                <div>
                                    ...
                                    <textarea name="description" rows="3" class="mt-1 block w-full border-default rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"></textarea>
                                </div>
                                
                                <div class="grid grid-cols-2 gap-4">
                                    <div>
                                        <label class="block text-sm font-medium text-foreground-muted">Start Date</label>
                                        <input type="date" name="start_date" class="mt-1 block w-full border-default rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required>
                                    </div>
                                    <div>
                                        <label class="block text-sm font-medium text-foreground-muted">End Date</label>
                                        <input type="date" name="end_date" class="mt-1 block w-full border-default rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                                    </div>
                                </div>

                                <div>
                                    <label class="block text-sm font-medium text-foreground-muted">Schedule Action</label>
                                    <select name="schedule_action" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-default focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md" required>
