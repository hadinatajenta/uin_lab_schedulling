    ...
    <div class="px-4 py-8 mx-auto max-w-3xl sm:px-6 lg:px-8">
        <div class="mb-8 flex items-center gap-4">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">Create a new laboratory room.</p>
            </div>
        </div>
            ...
            <form action="{{ route('rooms.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="room_code" id="room_code" value="{{ old('room_code') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required placeholder="e.g. BIO-01">
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_ruangan" id="nama_ruangan" value="{{ old('nama_ruangan') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required placeholder="e.g. Lab Biologi Dasar">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                    <div>
                        ...
                        <input type="text" name="building" id="building" value="{{ old('building') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    </div>
                    <div>
                        <label for="floor" class="block text-sm font-medium text-gray-700">Floor</label>
                        <input type="text" name="floor" id="floor" value="{{ old('floor') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                    </div>
                    <div>
                        <label for="kapasitas" class="block text-sm font-medium text-gray-700">Capacity (People)</label>
                        <input type="number" name="kapasitas" id="kapasitas" value="{{ old('kapasitas') }}" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" required min="1">
