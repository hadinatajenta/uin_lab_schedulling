    ...
    <div class="flex flex-row justify-between items-center gap-4">
        ...
        <div class="flex items-center gap-2 overflow-x-auto pb-1">
            ...
            @for ($page = $windowStart; $page <= $windowEnd; $page++)
                @if ($page == $currentPage)
                    <span
                        class="inline-flex items-center justify-center w-9 h-9 rounded-xl bg-indigo-50 text-indigo-700 text-xs font-bold ring-1 ring-indigo-200 shrink-0">{{ $page }}</span>
                @else
        ...
        <div class="flex items-center gap-2 shrink-0">
            ...
            <select
                ...
                class="bg-zinc-50 border border-zinc-200 text-zinc-800 text-xs font-semibold rounded-xl py-1.5 pl-2.5 pr-7 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 appearance-none cursor-pointer"
