    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        <div class="relative bg-white rounded-3xl shadow-xl border border-zinc-200">
            ...
            <div class="p-5 space-y-5 max-h-[70vh] overflow-y-auto hide-scrollbar">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="name" value="{{ old('name', $user->name) }}" required class="bg-zinc-50 border border-zinc-200 text-zinc-800 text-xs font-medium rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 block w-full p-2.5 transition-colors" />
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="phone_number" value="{{ old('phone_number', $user->phone_number) }}" class="bg-zinc-50 border border-zinc-200 text-zinc-800 text-xs font-medium rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 block w-full p-2.5 transition-colors" />
                ...
                <div x-show="hasStudent()" x-cloak class="space-y-4 p-4 rounded-xl bg-zinc-50/50 border border-zinc-100">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="nim" value="{{ old('nim', $user->nim) }}" :required="hasStudent()" class="bg-white border border-zinc-200 text-zinc-800 text-xs font-medium rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 block w-full p-2.5 transition-colors" />
                        ...
                        <div>
                            ...
                            <input type="number" name="entry_year" value="{{ old('entry_year', $user->entry_year) }}" :required="hasStudent()" class="bg-white border border-zinc-200 text-zinc-800 text-xs font-medium rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 block w-full p-2.5 transition-colors" />
                ...
                <div x-show="hasLecturer()" x-cloak class="space-y-4 p-4 rounded-xl bg-zinc-50/50 border border-zinc-100">
                    ...
                    <div>
                        ...
                        <input type="text" name="nip" value="{{ old('nip', $user->nip) }}" :required="hasLecturer()" class="bg-white border border-zinc-200 text-zinc-800 text-xs font-medium rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 block w-full p-2.5 transition-colors" />
            ...
            <div class="flex items-center justify-end px-5 py-4 border-t border-zinc-100 bg-zinc-50/50 rounded-b-3xl gap-3">
                ...
                <button type="submit" class="text-white bg-emerald-600 hover:bg-emerald-700 font-semibold rounded-xl text-xs px-4 py-2.5 transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-500">Simpan Perubahan</button>
            </div>
        </div>
    </div>
</form>
