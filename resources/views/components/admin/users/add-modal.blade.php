            ...
            <div class="p-5 space-y-5 max-h-[70vh] overflow-y-auto hide-scrollbar">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required class="bg-zinc-50 border border-zinc-200 text-zinc-800 text-xs font-medium rounded-xl focus:outline-none focus:ring-2 focus:ring-[rgb(var(--color-primary)_/_0.2)] focus:border-[rgb(var(--color-primary))] block w-full p-2.5 transition-colors" placeholder="Masukkan nama..." />
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" required class="bg-zinc-50 border border-zinc-200 text-zinc-800 text-xs font-medium rounded-xl focus:outline-none focus:ring-2 focus:ring-[rgb(var(--color-primary)_/_0.2)] focus:border-[rgb(var(--color-primary))] block w-full p-2.5 transition-colors" placeholder="email@contoh.com" />
                    ...
                    <div>
                        ...
                        <input type="text" name="phone_number" value="{{ old('phone_number') }}" class="bg-zinc-50 border border-zinc-200 text-zinc-800 text-xs font-medium rounded-xl focus:outline-none focus:ring-2 focus:ring-[rgb(var(--color-primary)_/_0.2)] focus:border-[rgb(var(--color-primary))] block w-full p-2.5 transition-colors" placeholder="08..." />
                ...
                <div x-show="hasStudent()" x-cloak class="space-y-4 p-4 rounded-xl bg-zinc-50/50 border border-zinc-100">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="nim" value="{{ old('nim') }}" :required="hasStudent()" class="bg-white border border-zinc-200 text-zinc-800 text-xs font-medium rounded-xl focus:outline-none focus:ring-2 focus:ring-[rgb(var(--color-primary)_/_0.2)] focus:border-[rgb(var(--color-primary))] block w-full p-2.5 transition-colors" placeholder="Masukkan NIM..." />
                        ...
                        <div>
                            ...
                            <input type="number" name="entry_year" value="{{ old('entry_year') }}" :required="hasStudent()" class="bg-white border border-zinc-200 text-zinc-800 text-xs font-medium rounded-xl focus:outline-none focus:ring-2 focus:ring-[rgb(var(--color-primary)_/_0.2)] focus:border-[rgb(var(--color-primary))] block w-full p-2.5 transition-colors" placeholder="2024" />
                ...
                <div x-show="hasLecturer()" x-cloak class="space-y-4 p-4 rounded-xl bg-zinc-50/50 border border-zinc-100">
                    ...
                    <div>
                        ...
                        <input type="text" name="nip" value="{{ old('nip') }}" :required="hasLecturer()" class="bg-white border border-zinc-200 text-zinc-800 text-xs font-medium rounded-xl focus:outline-none focus:ring-2 focus:ring-[rgb(var(--color-primary)_/_0.2)] focus:border-[rgb(var(--color-primary))] block w-full p-2.5 transition-colors" placeholder="Masukkan NIP..." />
