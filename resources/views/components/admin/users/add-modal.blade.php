    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        <div class="relative bg-white rounded-3xl shadow-xl border border-zinc-200">
            ...
            <div class="flex items-center justify-end px-5 py-4 border-t border-zinc-100 bg-zinc-50/50 rounded-b-3xl gap-3">
                ...
                <button type="submit" class="text-white bg-indigo-600 hover:bg-indigo-700 font-semibold rounded-xl text-xs px-4 py-2.5 transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">Tambah Pengguna</button>
            </div>
        </div>
    </div>
</form>
