<x-app-layout>
    ...
    <div class="py-12">
        <div class="flex flex-col h-full p-3 w-60 wedusbg-gray-50 wedustext-gray-800">
            <div class="space-y-3">
                <div class="flex items-center justify-between">
                    <h2>Dashboard</h2>
                    <button class="p-2">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                            class="w-5 h-5 fill-current wedustext-gray-800">
                ...
                <div class="relative">
                    <span class="absolute inset-y-0 left-0 flex items-center py-4">
                        <button type="submit" class="p-2 focus:outline-none focus:ring">
                            <svg fill="currentColor" viewBox="0 0 512 512" class="w-5 h-5 wedustext-gray-600">
                                <path
                    ...
                    <input type="search" name="Search" placeholder="Search..."
                        class="w-full py-2 pl-10 text-sm wedusborder- rounded-md focus:outline-none wedusbg-gray-100 wedustext-gray-800 focus:wedusbg-gray-50">
                </div>
                <div class="flex-1">
                    <ul class="pt-2 pb-4 space-y-1 text-sm">
                        <li class="rounded-sm">
                            <a rel="noopener noreferrer" href="#"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                    class="w-5 h-5 fill-current wedustext-gray-600">
                                    <path
                        ...
                        <li class="rounded-sm wedusbg-gray-100 wedustext-gray-900">
                            <a rel="noopener noreferrer" href="#"
                                class="flex items-center p-2 space-x-3 rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                    class="w-5 h-5 fill-current wedustext-gray-600">
            ...
            <div class="flex items-center p-2 mt-12 space-x-4 justify-self-end">
                <img src="https://source.unsplash.com/100x100/?portrait" alt=""
                    class="w-12 h-12 rounded-lg wedusbg-gray-500">
                <div>
                    <h2 class="text-lg font-semibold">Leroy Jenkins</h2>
                    <span class="flex items-center space-x-1">
                        <a rel="noopener noreferrer" href="#"
                            class="text-xs hover:underline wedustext-gray-600">View profile</a>
                    </span>
                </div>
            </div>
        </div>
