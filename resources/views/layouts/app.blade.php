                ...
                <ul class="space-y-2 font-medium p-4">
                    ...
                    <li>
                        <a href="{{ route('laporanPeminjaman') }}"
                            class="flex items-center p-2 rounded-lg group {{ request()->routeIs('laporanPeminjaman') ? 'text-white font-bold bg-[#8685EF]' : 'text-gray-900 hover:bg-gray-100 wedushover:bg-gray-700' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
                                    d="m20.25 7.5-.625 10.632a2.25 2.25 0 0 1-2.247 2.118H6.622a2.25 2.25 0 0 1-2.247-2.118L3.75 7.5M10 11.25h4M3.375 7.5h17.25c.621 0 1.125-.504 1.125-1.125v-1.5c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v1.5c0 .621.504 1.125 1.125 1.125Z" />
                            ...
                            <span class="flex-1 ms-3 whitespace-nowrap">Laporan Peminjaman</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('limbah') }}"
