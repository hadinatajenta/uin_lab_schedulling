                ...
                <div class="p-5">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('detailLimbah', $lbh->id) }}"
                            class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 wedusbg-blue-600 wedushover:bg-blue-700 wedusfocus:ring-blue-800">
                            Read more
