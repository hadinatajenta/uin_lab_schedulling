...
@section('content')
    ...
    <section class="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md wedusbg-gray-800">
        <h2 class="text-lg font-semibold text-gray-700 capitalize wedustext-white">Jadwal Baru</h2>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="flex items-center ps-4 border border-gray-200 rounded wedusborder-gray-700">
                            ...
                            <label for="bordered-radio-1"
                                class="w-full py-4 ms-2 text-sm font-medium text-gray-900 wedustext-gray-300">Ruangan
                                1</label>
                        </div>
                        <div class="flex items-center ps-4 border border-gray-200 rounded wedusborder-gray-700">
