...
@section('content')
 ...
 <div>
 <h4 class="text-2xl font-bold ">Tambah data alat / bahan</h4>
 ...
 class="w-full py-4 ms-2 text-sm font-medium text-gray-900 ">Alat
 </label>
 </div>
 </div>
 {{-- Bahan --}}
 ...
 class="w-full py-4 ms-2 text-sm font-medium text-gray-900 ">Bahan</label>
 </div>
 </div>
 </div>
 </div>
 ...
 <label for="kondisi" class="ms-2 text-sm font-medium text-gray-900 ">Baru</label>
 </div>
 <div class="flex items-center mb-4">
 ...
 <label for="kondisi-2"
 class="ms-2 text-sm font-medium text-gray-900 ">Bekas</label>
 </div>
 <div class="flex items-center mb-4">
 ...
 <label for="kondisi-3"
 class="ms-2 text-sm font-medium text-gray-900 ">Rusak</label>
 </div>
 <div class="flex items-center mb-4">
 <input id="kondisi-4" type="radio" value="Hampir habis" name="kondisi"
 class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2 "
 {{ $edit->kondisi == 'Hampir habis' ? 'checked' : '' }}>
 <label for="kondisi-4" class="ms-2 text-sm font-medium text-gray-900 ">Hampir
 habis</label>
 </div>
 <div class="flex items-center mb-4">
 ...
 <label for="kondisi-5"
 class="ms-2 text-sm font-medium text-gray-900 ">Habis</label>
 </div>
 <div class="flex items-center mb-4">
 ...
 <label for="kondisi-6"
 class="ms-2 text-sm font-medium text-gray-900 ">Layak</label>
 </div>
 <div class="flex items-center mb-4">
 <input id="kondisi-7" type="radio" value="Tidak Layak" name="kondisi"
 class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2 "
 {{ $edit->kondisi == 'Tidak Layak' ? 'checked' : '' }}>
 <label for="kondisi-7" class="ms-2 text-sm font-medium text-gray-900 ">Tidak
 Layak</label>
 </div>
 </div>
 ...
 <p id="helper-text-explanation" class="mt-2 text-sm text-gray-500 ">Jika tidak
