...
@section('content')
    ...
    <div class="px-2 pb-12 max-w-7xl mx-auto">
        <div class="mb-8">
            <p class="text-xs font-bold uppercase tracking-[0.2em] text-indigo-600">Detail Limbah</p>
            ...
            <aside class="xl:col-span-3 xl:sticky xl:top-6 self-start">
                <div class="bg-white border border-zinc-200/80 rounded-3xl shadow-sm p-5">
                    ...
                    <nav class="mt-4 space-y-1">
                        <a href="#cara-penggunaan" class="flex items-center justify-between rounded-2xl px-3 py-2 text-sm font-medium text-zinc-600 hover:bg-zinc-50 hover:text-indigo-700 transition-colors">
                            <span>Cara penggunaan</span><span class="text-zinc-300">›</span>
                        </a>
                        <a href="#materi" class="flex items-center justify-between rounded-2xl px-3 py-2 text-sm font-medium text-zinc-600 hover:bg-zinc-50 hover:text-indigo-700 transition-colors">
                            <span>Materi</span><span class="text-zinc-300">›</span>
                        </a>
                        <a href="#cara-pengolahan" class="flex items-center justify-between rounded-2xl px-3 py-2 text-sm font-medium text-zinc-600 hover:bg-zinc-50 hover:text-indigo-700 transition-colors">
                    ...
                    <div class="p-6 md:p-8 space-y-8">
                        <section id="cara-penggunaan">
                            <div class="flex items-center justify-between gap-3 mb-4">
                                ...
                                <x-ui.badge type="indigo">Panduan</x-ui.badge>
                            </div>
